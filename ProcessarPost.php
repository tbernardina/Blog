...
// Código de insert dos posts criados
    ...
    if (!empty($titulo) && !empty($conteudo)) { // Verifica se tanto o título quanto o conteúdo não estão vazios e faz a inserção do post ao banco de dados
        $sql = "INSERT INTO u210937242_posts (TITULO, CONTEUDO, ANEXOS, USER_ID, DATA_PUBLICACAO) VALUES ('$titulo', '$conteudo', '".$anexos['name']."', '$autor', '$data_publicacao')"; // Query de insert das informações dos posts
